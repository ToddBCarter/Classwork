        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pet Table Management</h4>
                  <p class="card-description">
                    Enter pet information
                    Deletion and updating will occur in accordance to the PetId entered.
                  </p>
                  <form class="forms-sample" action="pets_handler.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="petname" name="petname" placeholder="petname">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="typeofpet">TypeofPet</label>
                      <input type="text" class="form-control" id="typeofpet" name="typeofpet" placeholder="typeofpet">
                    </div>

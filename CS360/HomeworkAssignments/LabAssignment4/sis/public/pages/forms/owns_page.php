    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../forms/pets_page.php">Pets Page</a></li>
          <li class="nav-item"> <a class="nav-link" href="../forms/owners_page.php">Owners Page</a></li>
          <li class="nav-item"> <a class="nav-link" href="../forms/owns_page.php">Owns Page</a></li>
          <li class="nav-item"> <a class="nav-link" href="../forms/foods_page.php">Foods Page</a></li>
          <li class="nav-item"> <a class="nav-link" href="../forms/purchases_page.php">Purchases Page</a></li>
        </ul>
      </div>
    </li>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Owns Table Management</h4>
                  <p class="card-description">
                    Enter information about who owns what pet.
                    This goes in accordance of the Pet ID and the Owner ID.
                  </p>
                  <form class="forms-sample" action="owns_handler.php" method="post">
                    <div class="form-group">
                      <label for="petID">Pet ID</label>
                      <input type="text" class="form-control" id="petID" name="petID" placeholder="petID">
                    </div>
                    <div class="form-group">
                      <label for="year">Year of Ownership</label>
                      <input type="number" class="form-control" id="year" name="year" placeholder="year">
                    </div>
                    <div class="form-group">
                      <label for="OID">Owner ID</label>
                      <input type="text" class="form-control" id="OID" name="OID" placeholder="OID">
                    </div>
                    <div class="form-group">
                      <label for="age">PetAgeatOwnership</label>
                      <input type="text" class="form-control" id="age" name="age" placeholder="age">
                    </div>
                    <div class="form-group">
                      <label for="price">PricePaid</label>
                      <input type="text" class="form-control" id="price" name="price" placeholder="price">
                    </div>
                    
                    <!-- Action Buttons -->
                    <button type="submit" name="action" value="create" class="btn btn-success me-2">Create</button>
                    <button type="submit" name="action" value="read" class="btn btn-info me-2">Read</button>

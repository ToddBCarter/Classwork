        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Purchases Table Management</h4>
                  <p class="card-description">
                    Enter information about different purchases on the database.
                  </p>
                  <form class="forms-sample" action="purchases_handler.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="foodID" name="foodID" placeholder="foodID">
                    </div>
                    <div class="form-group">

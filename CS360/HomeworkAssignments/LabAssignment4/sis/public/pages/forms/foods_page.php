        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Foods Table Management</h4>
                  <p class="card-description">
                    Enter information about different pet foods.
                  </p>
                  <form class="forms-sample" action="foods_handler.php" method="post">
                    <div class="form-group">
                      <label for="foodID">Food ID</label>
                      <input type="text" class="form-control" id="foodID" name="foodID" placeholder="Food ID">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="classoffood" name="classoffood" placeholder="classoffood">
                    </div>

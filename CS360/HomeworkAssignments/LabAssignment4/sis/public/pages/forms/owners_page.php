        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Owners Table Management</h4>
                  <p class="card-description">
                    Enter owner information.<br>
                    Deletion and updates will occur in accordance to the Owner ID entered.
                  </p>
                  <form class="forms-sample" action="owners_handler.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="AnnualIncome">AnnualIncome</label>
                      <input type="number" class="form-control" id="AnnualIncome" name="AnnualIncome" placeholder="AnnualIncome">
                    </div>
